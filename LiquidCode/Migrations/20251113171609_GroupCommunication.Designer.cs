...
namespace LiquidCode.Migrations
{
    ...
    [Migration("20251113171609_GroupCommunication")]
    partial class GroupCommunication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiquidCode.Infrastructure.Database.Entities.DbGroupChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_group_chat_messages_group_id");

                    b.ToTable("group_chat_messages", (string)null);
                });

            modelBuilder.Entity("LiquidCode.Infrastructure.Database.Entities.DbGroupFeedPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_group_feed_posts");

                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_group_feed_posts_author_id");

                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_group_feed_posts_group_id");

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("ix_group_feed_posts_is_deleted");

                    b.ToTable("group_feed_posts", (string)null);
                });
            ...
            modelBuilder.Entity("LiquidCode.Infrastructure.Database.Entities.DbMission", b =>
                {
                    ...
                    b.Property<int?>("MemoryLimitBytes")
                        .HasColumnType("integer")
                        .HasColumnName("memory_limit_bytes");
                    ...
                    b.Property<int?>("TimeLimitMilliseconds")
                        .HasColumnType("integer")
                        .HasColumnName("time_limit_milliseconds");
            ...
            modelBuilder.Entity("LiquidCode.Infrastructure.Database.Entities.DbGroupChatMessage", b =>
                {
                    ...
                    b.HasOne("LiquidCode.Infrastructure.Database.Entities.DbGroup", "Group")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_group_chat_messages_groups_group_id");
            ...
            modelBuilder.Entity("LiquidCode.Infrastructure.Database.Entities.DbGroupFeedPost", b =>
                {
                    b.HasOne("LiquidCode.Infrastructure.Database.Entities.DbUser", "Author")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_group_feed_posts_users_author_id");
                    ...
                    b.HasOne("LiquidCode.Infrastructure.Database.Entities.DbGroup", "Group")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_group_feed_posts_groups_group_id");
